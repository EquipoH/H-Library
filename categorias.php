  ...
  <div class="container">
    <div class="row">
      ...
      <div class="card-columns">
        ...
        $sql = $connect->query("SELECT libro.*,categoria.nombre as categoria,artista.nombre as artista FROM `libro` inner join categoria on categoria.id=libro.categoria inner JOIN artista on artista.id=libro.artista WHERE libro.categoria=1 ORDER BY fechaAniadido DESC ");
        $result = array();
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="card-columns">
            ...
            $sql = $connect->query("SELECT libro.*,categoria.nombre as categoria,artista.nombre as artista FROM `libro` inner join categoria on categoria.id=libro.categoria inner JOIN artista on artista.id=libro.artista WHERE libro.categoria=2 ORDER BY fechaAniadido DESC");
            $result = array();
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="card-columns">
                ...
                $sql = $connect->query("SELECT libro.*,categoria.nombre as categoria,artista.nombre as artista FROM `libro` inner join categoria on categoria.id=libro.categoria inner JOIN artista on artista.id=libro.artista WHERE libro.categoria=3 ORDER BY fechaAniadido DESC");
                $result = array();
              ...
              <div class="container">
                <div class="row">
                  ...
                  <div class="card-columns">
                    ...
                    $sql = $connect->query("SELECT libro.*,categoria.nombre as categoria,artista.nombre as artista FROM `libro` inner join categoria on categoria.id=libro.categoria inner JOIN artista on artista.id=libro.artista WHERE libro.categoria=4 ORDER BY fechaAniadido DESC");
                    $result = array();
                  ...
                  <div class="container">
                    <div class="row">
                      ...
                      <div class="card-columns">
                        ...
                        $sql = $connect->query("SELECT libro.*,categoria.nombre as categoria,artista.nombre as artista FROM `libro` inner join categoria on categoria.id=libro.categoria inner JOIN artista on artista.id=libro.artista WHERE libro.categoria=5 ORDER BY fechaAniadido DESC");
                        $result = array();
                      ...
                      <div class="container">
                        <div class="row">
                          ...
                          <div class="card-columns">
                            ...
                            $sql = $connect->query("SELECT libro.*,categoria.nombre as categoria,artista.nombre as artista FROM `libro` inner join categoria on categoria.id=libro.categoria inner JOIN artista on artista.id=libro.artista WHERE libro.categoria=6 ORDER BY fechaAniadido DESC");
                            $result = array();
